...
func (a *Authenticator) Description() string              { return "Obtain certificates using a DNS TXT record via the Sakura Cloud API." }
...
func (a *Authenticator) Prepare(_ context.Context, cfg *config.Config, _ []string) (plugins.ChallengeKind, challenge.Provider, error) {
	...
	common.PropagationEnv("SAKURACLOUD_", common.PropagationFor(cfg, "sakuracloud"))
